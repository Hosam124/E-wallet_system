...
import exception.EWalletException;
        ...
        while (true){
            ...
            try{
                ...
                if (numberOfAttempts>MAX_ATTEMPTS){
                    throw new MaxAttemptsExceededException("Many times of invalid choose pls contact with admin :(.......");
                }
    ...
    private void login() {
        try{
            ...
            do {
                ...
                numberOfAttempts++;
                if (numberOfAttempts>MAX_ATTEMPTS) {
                    throw new MaxAttemptsExceededException("Many times of invalid user name or password pls try later :(.......");
                }
    ...
    public void showAdminPanel(Account account){
        try{
            ...
            while (true){
                ...
                if (numberOfAttempts>MAX_ATTEMPTS){
                    throw new MaxAttemptsExceededException("Many times of invalid choose pls try later :(.......");
                }
